...
public class Decoder {
    ...
    public Decoder() {
        ...
        instructionSet.put(0x08, new LoadInstruction(SourceSP.INSTANCE, DestinationReference16bits.INSTANCE_WORD, 3, 20));
        ...
        instructionSet.put(0x18, new JumpInstruction(SourceImmediate8Bits.INSTANCE, 2, 12, true));
        ...
        instructionSet.put(0x34, new IncrementInstruction(SourceReferenceHL.INSTANCE_DEFAULT, DestinationReferenceHL.INSTANCE_DEFAULT, 12, true));
        instructionSet.put(0x35, new DecrementInstruction(SourceReferenceHL.INSTANCE_DEFAULT, DestinationReferenceHL.INSTANCE_DEFAULT, 12, true));
        ...
        instructionSet.put(0xC0, new ReturnInstruction(Condition.NOT_ZERO, 20, 8));
        ...
        instructionSet.put(0xC6, new AdditionInstruction(SourceImmediate8Bits.INSTANCE, 8, false, 2));
        instructionSet.put(0xC7, new ResetInstruction(0));
        instructionSet.put(0xC8, new ReturnInstruction(Condition.ZERO, 20, 8));
        ...
        instructionSet.put(0xCE, new AdditionInstruction(SourceImmediate8Bits.INSTANCE, 8, true, 2));
        instructionSet.put(0xCF, new ResetInstruction(8));
        instructionSet.put(0xD0, new ReturnInstruction(Condition.NOT_CARRY, 20, 8));
        ...
        instructionSet.put(0xD6, new SubtractionInstruction(SourceImmediate8Bits.INSTANCE, 8, false, 2));
        instructionSet.put(0xD7, new ResetInstruction(0x10));
        instructionSet.put(0xD8, new ReturnInstruction(Condition.CARRY, 20, 8));
        ...
        instructionSet.put(0xDE, new SubtractionInstruction(SourceImmediate8Bits.INSTANCE, 8, true, 2));
        ...
        instructionSet.put(0xE8, new AddSignedImmediateToStackPointerInstruction(DestinationSP.INSTANCE, 16));
        ...
        instructionSet.put(0xF8, new AddSignedImmediateToStackPointerInstruction(DestinationHL.INSTANCE, 12));
        ...
        instructionSet.put(0xCB00, new RotateInstruction(RotateDirection.LEFT, SourceB.INSTANCE, DestinationB.INSTANCE, 8, false, true, false));
        instructionSet.put(0xCB01, new RotateInstruction(RotateDirection.LEFT, SourceC.INSTANCE, DestinationC.INSTANCE, 8, false, true, false));
        instructionSet.put(0xCB02, new RotateInstruction(RotateDirection.LEFT, SourceD.INSTANCE, DestinationD.INSTANCE, 8, false, true, false));
        instructionSet.put(0xCB03, new RotateInstruction(RotateDirection.LEFT, SourceE.INSTANCE, DestinationE.INSTANCE, 8, false, true, false));
        instructionSet.put(0xCB04, new RotateInstruction(RotateDirection.LEFT, SourceH.INSTANCE, DestinationH.INSTANCE, 8, false, true, false));
        instructionSet.put(0xCB05, new RotateInstruction(RotateDirection.LEFT, SourceL.INSTANCE, DestinationL.INSTANCE, 8, false, true, false));
        instructionSet.put(0xCB06, new RotateInstruction(RotateDirection.LEFT, SourceReferenceHL.INSTANCE_DEFAULT, DestinationReferenceHL.INSTANCE_DEFAULT, 16, false, true, false));
        instructionSet.put(0xCB07, new RotateInstruction(RotateDirection.LEFT, SourceA.INSTANCE, DestinationA.INSTANCE, 8, false, true, false));
        ...
        instructionSet.put(0xCB27, new ShiftArithmeticallyInstruction(RotateDirection.LEFT, SourceA.INSTANCE, DestinationA.INSTANCE, 8));
