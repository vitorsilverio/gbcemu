...
public class Decoder {
    ...
    public Decoder() {
        ...
        instructionSet.put(0x07, new RotateInstruction(RotateDirection.LEFT, SourceA.INSTANCE, DestinationA.INSTANCE, 4, true, false));
        ...
        instructionSet.put(0x0F, new RotateInstruction(RotateDirection.RIGHT, SourceA.INSTANCE, DestinationA.INSTANCE, 4, true, false));
        ...
        instructionSet.put(0x17, new RotateInstruction(RotateDirection.LEFT, SourceA.INSTANCE, DestinationA.INSTANCE, 4, false, false));
        ...
        instructionSet.put(0x1F, new RotateInstruction(RotateDirection.RIGHT, SourceA.INSTANCE, DestinationA.INSTANCE, 4, false, false));
        ...
        instructionSet.put(0xCB01, new RotateInstruction(RotateDirection.LEFT, SourceB.INSTANCE, DestinationB.INSTANCE, 8, false, true));
        instructionSet.put(0xCB02, new RotateInstruction(RotateDirection.LEFT, SourceC.INSTANCE, DestinationC.INSTANCE, 8, false, true));
        instructionSet.put(0xCB03, new RotateInstruction(RotateDirection.LEFT, SourceD.INSTANCE, DestinationD.INSTANCE, 8, false, true));
        instructionSet.put(0xCB04, new RotateInstruction(RotateDirection.LEFT, SourceE.INSTANCE, DestinationE.INSTANCE, 8, false, true));
        instructionSet.put(0xCB05, new RotateInstruction(RotateDirection.LEFT, SourceH.INSTANCE, DestinationH.INSTANCE, 8, false, true));
        instructionSet.put(0xCB06, new RotateInstruction(RotateDirection.LEFT, SourceL.INSTANCE, DestinationL.INSTANCE, 8, false, true));
        instructionSet.put(0xCB07, new RotateInstruction(RotateDirection.LEFT, SourceReferenceHL.INSTANCE_DEFAULT, DestinationReferenceHL.INSTANCE_DEFAULT, 16, false, true));
        instructionSet.put(0xCB08, new RotateInstruction(RotateDirection.RIGHT, SourceB.INSTANCE, DestinationB.INSTANCE, 8, false, true));
        instructionSet.put(0xCB09, new RotateInstruction(RotateDirection.RIGHT, SourceC.INSTANCE, DestinationC.INSTANCE, 8, false, true));
        instructionSet.put(0xCB0A, new RotateInstruction(RotateDirection.RIGHT, SourceD.INSTANCE, DestinationD.INSTANCE, 8, false, true));
        instructionSet.put(0xCB0B, new RotateInstruction(RotateDirection.RIGHT, SourceE.INSTANCE, DestinationE.INSTANCE, 8, false, true));
        instructionSet.put(0xCB0C, new RotateInstruction(RotateDirection.RIGHT, SourceH.INSTANCE, DestinationH.INSTANCE, 8, false, true));
        instructionSet.put(0xCB0D, new RotateInstruction(RotateDirection.RIGHT, SourceL.INSTANCE, DestinationL.INSTANCE, 8, false, true));
        instructionSet.put(0xCB0E, new RotateInstruction(RotateDirection.RIGHT, SourceReferenceHL.INSTANCE_DEFAULT, DestinationReferenceHL.INSTANCE_DEFAULT, 16, false, true));
        instructionSet.put(0xCB0F, new RotateInstruction(RotateDirection.RIGHT, SourceA.INSTANCE, DestinationA.INSTANCE, 8, false, true));
        instructionSet.put(0xCB10, new RotateInstruction(RotateDirection.LEFT, SourceB.INSTANCE, DestinationB.INSTANCE, 8, true, true));
        instructionSet.put(0xCB11, new RotateInstruction(RotateDirection.LEFT, SourceC.INSTANCE, DestinationC.INSTANCE, 8, true, true));
        instructionSet.put(0xCB12, new RotateInstruction(RotateDirection.LEFT, SourceD.INSTANCE, DestinationD.INSTANCE, 8, true, true));
        instructionSet.put(0xCB13, new RotateInstruction(RotateDirection.LEFT, SourceE.INSTANCE, DestinationE.INSTANCE, 8, true, true));
        instructionSet.put(0xCB14, new RotateInstruction(RotateDirection.LEFT, SourceH.INSTANCE, DestinationH.INSTANCE, 8, true, true));
        instructionSet.put(0xCB15, new RotateInstruction(RotateDirection.LEFT, SourceL.INSTANCE, DestinationL.INSTANCE, 8, true, true));
        instructionSet.put(0xCB16, new RotateInstruction(RotateDirection.LEFT, SourceReferenceHL.INSTANCE_DEFAULT, DestinationReferenceHL.INSTANCE_DEFAULT, 16, true, true));
        instructionSet.put(0xCB17, new RotateInstruction(RotateDirection.LEFT, SourceA.INSTANCE, DestinationA.INSTANCE, 8, true, true));
        instructionSet.put(0xCB18, new RotateInstruction(RotateDirection.RIGHT, SourceB.INSTANCE, DestinationB.INSTANCE, 8, true, true));
        instructionSet.put(0xCB19, new RotateInstruction(RotateDirection.RIGHT, SourceC.INSTANCE, DestinationC.INSTANCE, 8, true, true));
        instructionSet.put(0xCB1A, new RotateInstruction(RotateDirection.RIGHT, SourceD.INSTANCE, DestinationD.INSTANCE, 8, true, true));
        instructionSet.put(0xCB1B, new RotateInstruction(RotateDirection.RIGHT, SourceE.INSTANCE, DestinationE.INSTANCE, 8, true, true));
        instructionSet.put(0xCB1C, new RotateInstruction(RotateDirection.RIGHT, SourceH.INSTANCE, DestinationH.INSTANCE, 8, true, true));
        instructionSet.put(0xCB1D, new RotateInstruction(RotateDirection.RIGHT, SourceL.INSTANCE, DestinationL.INSTANCE, 8, true, true));
        instructionSet.put(0xCB1E, new RotateInstruction(RotateDirection.RIGHT, SourceReferenceHL.INSTANCE_DEFAULT, DestinationReferenceHL.INSTANCE_DEFAULT, 16, true, true));
        instructionSet.put(0xCB1F, new RotateInstruction(RotateDirection.RIGHT, SourceA.INSTANCE, DestinationA.INSTANCE, 8, true, true));
